...
CREATE TABLE cliente (
    ...
    nome VARCHAR(100) NOT NULL,
    email VARCHAR(150) UNIQUE NOT NULL,
    password_hash VARCHAR(255) NOT NULL, -- adicionei
...
CREATE TABLE demo (
    ...
    imagem_docker TEXT NOT NULL,  -- Ex: 'ltplabs/crm-demo:v1.2.0'ADICIONEI
...
CREATE TABLE pedido (
    ...
    tipo_pedido TEXT NOT NULL CHECK(tipo_pedido IN ('renovação', 'revogação')), -- ADICIONEI só renovação
    criado_em TEXT DEFAULT (datetime('now')),
